...
__all__ = [ 'Gray', 'FONTSTRIKETHROUGH', 'IFontEventsDisp',
           'OLE_COLOR', 'IPicture', 'OLE_OPTEXCLUSIVE', 'FONTSIZE',
           'OLE_XSIZE_CONTAINER', 'FontEvents', 'OLE_YSIZE_HIMETRIC',
           'FONTUNDERSCORE', 'OLE_TRISTATE', 'OLE_XPOS_CONTAINER',
           'IFont', 'VgaColor', 'Checked', 'Monochrome',
           'OLE_XPOS_PIXELS', 'OLE_XPOS_HIMETRIC',
           'OLE_YPOS_HIMETRIC', 'IFontDisp', 'Color', 'FONTITALIC',
           'Unchecked', 'OLE_YSIZE_PIXELS', 'OLE_YSIZE_CONTAINER',
           'StdFont', 'OLE_YPOS_PIXELS', 'OLE_ENABLEDEFAULTBOOL',
           'FONTNAME', 'FONTBOLD', 'Font', 'Default', 'IPictureDisp',
           'StdPicture', 'OLE_HANDLE', 'OLE_XSIZE_PIXELS',
           'OLE_YPOS_CONTAINER', 'Picture', 'OLE_CANCELBOOL',
